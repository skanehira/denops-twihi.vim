...
export * as datetime from "https://deno.land/std@0.194.0/datetime/mod.ts";
...
export { copy } from "https://deno.land/std@0.194.0/streams/copy.ts";
export * as helper from "https://deno.land/x/denops_std@v5.0.1/helper/mod.ts";
export * as http from "https://deno.land/std@0.194.0/http/mod.ts";
