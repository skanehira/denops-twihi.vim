...
export * as datetime from "https://deno.land/std@0.173.0/datetime/mod.ts";
...
export { copy } from "https://deno.land/std@0.173.0/streams/copy.ts";
export * as helper from "https://deno.land/x/denops_std@v4.0.0/helper/mod.ts";
export * as http from "https://deno.land/std@0.173.0/http/mod.ts";
