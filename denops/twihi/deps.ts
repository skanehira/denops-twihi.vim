...
export * as datetime from "https://deno.land/std@0.183.0/datetime/mod.ts";
...
export { copy } from "https://deno.land/std@0.183.0/streams/copy.ts";
export * as helper from "https://deno.land/x/denops_std@v4.1.5/helper/mod.ts";
export * as http from "https://deno.land/std@0.183.0/http/mod.ts";
